...
public class Queries {
    ...
    public static final String CREATE_END_DATES_VIEW = "USE [LondonU2]\n"
            + "GO\n"
            + "\n"
            + "IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[endDates]'))\n"
    ...
    public static final String CREATE_VIEW_numOfCardsForPrice = "USE [LondonU2]\n"
            + "GO\n"
            + "\n"
            + "IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[numOfCardsForPrice]'))\n"
    ...
    public static final String CREATE_VIEW_yearsWithMoreThan5000 = "USE [LondonU2]\n"
            + "GO\n"
            + "\n"
            + "IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[yearsWithMoreThan5000]'))\n"
    ...
    public static final String CREATE_VIEW_NumOfOysterRides = "USE [LondonU2]\n"
            + "GO\n"
            + "\n"
            + "IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[NumOfOysterRides]'))\n"
            ...
            + "GO\n"
            + "\n"
            + "create view [dbo].[NumOfOysterRides] as\n"
            + "select YEAR(A.activityDate) as theYear,COUNT(*) as 'num of rides for\n"
            + "Oyster'\n"
            + "from tblOysterCard OC inner join tblActivity A\n"
    ...
    public static final String QUERY7 = "select year(A.activityDate),\n"
            ...
            + "year(A.activityDate) = NOR.theYear, yearsWithMoreThan0555 YM\n"
            + "where (year(A.activityDate)>=YM.depositStartYear and\n"
            + "year(A.activityDate)<=YM.depositEndYear)\n"
